...
<body>
    ...
    <main>
        ...
        $sql = "INSERT INTO `academia`.`treinadores` (`nome`, `dataDeNascimento`, `cpf`, `endereco`, `telefone`, `email`, `idPagamento`) VALUES ";
        $sql .= "('$nome', '$dataDeNascimento','$cpf', '$endereco', '$telefone' ,'$email', '$idPagamento')";
        $conn->query($sql);
        ...
        ?>
        <br>
        <a href='form_treinador.php'>Voltar</a><br>
