    ...
    <div class="container">
        <main>
            <div class="py-5 text-center">
                <h2>Cadastro de Treinadores</h2>
            </div>
            <div class="col-md-7 col-lg-10">
                <h4 class="mb-3">Dados Pessoais</h4>
                <form class="needs-validation" novalidate action="cadastro_treinador.php" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="country" class="form-label">Trabalha com o plano</label>
                            <?php
                            require 'banco.php';
