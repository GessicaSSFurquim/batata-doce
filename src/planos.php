    ...
    <div class="container">
        ...
        <a class="btn btn-secondary" href="/admin.php" role="button">Voltar</a>
            <div class="py-5 text-center">
                ...
                <?php
                require 'banco.php';
                $sql = "SELECT * FROM `academia`.`planos`";
                ...
                if ($planos->num_rows == 0) {
                    ...
                    while ($plano = $planos->fetch_assoc()) {
                        ...
                        echo "<td>$plano[valor]</td>";
                        echo "<td><a href='form_edita_plano.php?idPlano=$plano[idPlano]'>Editar</a></td>";
                        echo "<td><a href='remove_plano.php?idPlano=$plano[idPlano]'>Remover</a></td>";
                        echo "</tr>";
                    }
                    echo "</table>";
                }
